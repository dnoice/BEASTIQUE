<!--
✒ Metadata
    - Title: Polar Beasts Collection README (BEASTIQUE Edition - v1.0)
    - File Name: README.md
    - Relative Path: collections/polar-beasts/README.md
    - Artifact Type: docs
    - Version: 1.0.0
    - Date: 2025-12-02
...
✒ Description:
    Documentation for the Polar Beasts collection within the BEASTIQUE project.
...
> *Ice-dependent species from Arctic and Antarctic—watching their world melt in real-time.*

---

## Collection Overview

The **Polar Beasts** collection contains BEASTIQUE artworks depicting endangered species
