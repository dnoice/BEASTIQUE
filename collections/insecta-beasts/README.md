<!--
✒ Metadata
    - Title: Insecta Beasts Collection README (BEASTIQUE Edition - v1.0)
    - File Name: README.md
    - Relative Path: collections/insecta-beasts/README.md
    - Artifact Type: docs
    - Version: 1.0.0
    - Date: 2025-12-02
...
✒ Description:
    Documentation for the Insecta Beasts collection within the BEASTIQUE project.
...
> *Six-legged multitudes—pollinators, decomposers, architects—the small engines that run the world.*

---

## Collection Overview

The **Insecta Beasts** collection contains BEASTIQUE artworks depicting endangered species
