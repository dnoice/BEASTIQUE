<!--
✒ Metadata
    - Title: Island Beasts Collection README (BEASTIQUE Edition - v1.0)
    - File Name: README.md
    - Relative Path: collections/island-beasts/README.md
    - Artifact Type: docs
    - Version: 1.0.0
    - Date: 2025-12-02
...
✒ Description:
    Documentation for the Island Beasts collection within the BEASTIQUE project.
...
> *Endemic isolates—species that evolved in island laboratories, vulnerable to every invasion.*

---

## Collection Overview

The **Island Beasts** collection contains BEASTIQUE artworks depicting endangered species
