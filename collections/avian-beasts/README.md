<!--
✒ Metadata
    - Title: Avian Beasts Collection README (BEASTIQUE Edition - v1.0)
    - File Name: README.md
    - Relative Path: collections/avian-beasts/README.md
    - Artifact Type: docs
    - Version: 1.0.0
    - Date: 2025-12-02
...
✒ Description:
    Documentation for the Avian Beasts collection within the BEASTIQUE project.
...
> *Feathered vertebrates with beaks, hollow bones, and the gift of flight—or the evolutionary choice to abandon it.*

---

## Collection Overview

The **Avian Beasts** collection contains BEASTIQUE artworks depicting endangered species
