<!--
✒ Metadata
    - Title: Endangered Beasts Collection README (BEASTIQUE Edition - v1.0)
    - File Name: README.md
    - Relative Path: collections/endangered-beasts/README.md
    - Artifact Type: docs
    - Version: 1.0.0
    - Date: 2025-12-02
...
✒ Description:
    Documentation for the Endangered Beasts collection within the BEASTIQUE project.
...
> *The most critical of the critical—species balanced on extinction's knife-edge, demanding immediate witness.*

---

## Collection Overview

The **Endangered Beasts** collection contains BEASTIQUE artworks depicting endangered species
