<!--
✒ Metadata
    - Title: Mammalian Beasts Collection README (BEASTIQUE Edition - v1.0)
    - File Name: README.md
    - Relative Path: collections/mammalian-beasts/README.md
    - Artifact Type: docs
    - Version: 1.0.0
    - Date: 2025-12-02
...
✒ Description:
    Documentation for the Mammalian Beasts collection within the BEASTIQUE project.
...
> *Warm-blooded vertebrates with fur or hair, mammary glands, and complex social structures.*

---

## Collection Overview

The **Mammalian Beasts** collection contains BEASTIQUE artworks depicting endangered species
