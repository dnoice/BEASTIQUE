<!--
✒ Metadata
    - Title: Nocturnal Beasts Collection README (BEASTIQUE Edition - v1.0)
    - File Name: README.md
    - Relative Path: collections/nocturnal-beasts/README.md
    - Artifact Type: docs
    - Version: 1.0.0
    - Date: 2025-12-02
...
✒ Description:
    Documentation for the Nocturnal Beasts collection within the BEASTIQUE project.
...
> *Creatures of darkness—evolved for night, threatened by light pollution and habitat loss.*

---

## Collection Overview

The **Nocturnal Beasts** collection contains BEASTIQUE artworks depicting endangered species
