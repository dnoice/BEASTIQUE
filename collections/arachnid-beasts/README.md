<!--
✒ Metadata
    - Title: Arachnid Beasts Collection README (BEASTIQUE Edition - v1.0)
    - File Name: README.md
    - Relative Path: collections/arachnid-beasts/README.md
    - Artifact Type: docs
    - Version: 1.0.0
    - Date: 2025-12-02
...
✒ Description:
    Documentation for the Arachnid Beasts collection within the BEASTIQUE project.
...
> *Eight-legged hunters and weavers—spiders, scorpions, and their kin—masters of silk and venom.*

---

## Collection Overview

The **Arachnid Beasts** collection contains BEASTIQUE artworks depicting endangered species
