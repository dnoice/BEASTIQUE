<!--
✒ Metadata
    - Title: Deep Sea Beasts Collection README (BEASTIQUE Edition - v1.0)
    - File Name: README.md
    - Relative Path: collections/deep-sea-beasts/README.md
    - Artifact Type: docs
    - Version: 1.0.0
    - Date: 2025-12-02
...
✒ Description:
    Documentation for the Deep Sea Beasts collection within the BEASTIQUE project.
...
> *Abyssal mysteries—species from depths we barely know, threatened before we understand them.*

---

## Collection Overview

The **Deep Sea Beasts** collection contains BEASTIQUE artworks depicting endangered species
